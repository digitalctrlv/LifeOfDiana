...
#first item
LadyDonYacht = read_csv("C:/Users/Utente/Desktop/LifeOfDiana/Lady Diana on holiday in Portofino.csv", keep_default_na = False, encoding = "utf-8")
...
#second item
CandleInTheWind = read_csv("C:/Users/Utente/Desktop/LifeOfDiana/Candle in the Wind 1997.csv", keep_default_na = False, encoding = "utf-8")
...
for _, row in CandleInTheWind.iterrows():
    ...
    g.add((song, OWL.sameAs, URIRef(wd + row["Wikidata"]))) #ok sistema tab
    ...
    g.add((song, schema.duration, Literal(row["Length"]))) #il dato non è completamente giusto
    ...
    #Bernie triples
    g.add((song, schema.contributor, lyr_and_contr)) #TOGLI SPAZIO FINALE IN CSV, rifai download
...
# third item
TheCrown =  read_csv("C:/Users/Utente/Desktop/LifeOfDiana/The Crown.csv", keep_default_na = False, encoding = "utf-8")
...
for _, row in TheCrown.iterrows():
    ...
    g.add((tvs, FOAF.depicts, LadyDiana_uri)) #diana
    g.add((tvs, FOAF.depicts, Charles_uri)) #charles
...
#fourth item
AlmaBridge = read_csv("C:/Users/Utente/Desktop/LifeOfDiana/Alma Bridge.csv", keep_default_na=False,encoding = "utf-8")
...
#fifth item
LadyDCharity = read_csv("C:/Users/Utente/Desktop/LifeOfDiana/AIDs_photo.csv", keep_default_na = None, encoding="utf-8")
...
for _,row in LadyDCharity.iterrows():
    ...
    g.add((photo2, schema.copyrightHolder, Literal(row["Source"]))) #qui dovrebbe essere sygma premium
...
#sixth item
DianaHerTrueStory = read_csv("C:/Users/Utente/Desktop/LifeOfDiana/Book.csv")
...
#seventh item
WeddingDress = read_csv("C:/Users/Utente/Desktop/LifeOfDiana/Wedd_dress.csv", keep_default_na = None, encoding="utf-8")
...
#eight item
SpencerTiara = read_csv("C:/Users/Utente/Desktop/LifeOfDiana/Spencer Tiara.csv", keep_default_na = None, encoding="utf-8")
...
#nine item
EngagementInterview = read_csv("C:/Users/Utente/Desktop/LifeOfDiana/engagement_interview.csv", keep_default_na = None, encoding="utf-8")
...
for _,row in EngagementInterview.iterrows():
    ...
    g.add((interview, schema.creator, dbr.BBC))# --> check this
...
#ten item
KensingtonPalace = read_csv("C:/Users/Utente/Desktop/LifeOfDiana/kensingtonpalace-meta.csv", keep_default_na=False, encoding="utf-8")
...
DivorceAnnouncement = read_csv("C:/Users/Utente/Desktop/LifeOfDiana/panorama1995-object-meta.csv", keep_default_na = False, encoding="utf-8")
